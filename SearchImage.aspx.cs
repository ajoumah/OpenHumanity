...
namespace Onder1
{
    public partial class SearchImage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Title = OnderShopConfiguration.SiteName + " : البحث في الصور : " + searchString;
            PopulateControls();
        }
        ...
        private void PopulateControls()
        {
            ...
            if (searchString != null)
            {
                ...
                DataTable GlobeDataTable = CatalogAccess.SearchImageGallery(searchString, allWords, page, out howManyPages);
                ...
                ImageRepeater.DataSource = GlobeDataTable;
                ImageRepeater.DataBind();

               
                firstPageUrl = Class1.ToSearchImage(searchString, allWords.ToUpper() == "TRUE", "1");

                pagerFormat = Class1.ToSearchImage(searchString, allWords.ToUpper() == "TRUE", "{0}");
