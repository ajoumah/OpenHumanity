<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="AddSingleProgramAdmin.aspx.cs" Inherits="Onder1.AddSingleProgramAdmin" %>
        ...
        <div class="m-5">
            ...
            <div>
                <p class="p-2 text-center">
                    <asp:Label ID="Label1" runat="server" ForeColor="red" Font-Size="30" Text="اضافة برنامج"></asp:Label>
                </p>
            </div>
                ...
                <div class="card " style="border-radius: 14px 14px 0 0;">
                    ...
                    <div class="row w-100 p-0 m-0 mb-5 border border-bottom-3 border-dark border-top-0 border-right-0 border-left-0 ">
                        <div class="item w-100" style="direction: rtl; float: right">
                            <p class="col-12 align-content-end  text-right font-style-motto   float-right " style="direction: rtl; float: right">
                                ...
                                <asp:Label ID="TitleLabel" runat="server" Text="عنوان البرنامج" Width="100%" class="col-12 align-content-end  text-right    float-right " Style="direction: rtl; float: right"></asp:Label>
                    ...
                    <div class="card-body  text-right border-bottom" style="direction: rtl">
                        <p class="col-12 font-Sector-paragraph text-right float-right" style="direction: rtl;">
                            <asp:Label ID="Label7" runat="server" text="وصف البرنامج"></asp:Label>
            ...
            <div class="row ">
                <div class="col text-center">
                    <asp:Button ID="CreateButton" class="btn btn-primary btn-lg" runat="server" Text="اضافة برنامج" Width="200" Height="40" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); font-family: Tajawal; font-size: 20px; border-radius: 12px;" OnClick="CreateButton_Click" />
                </div>
            </div>
            <div class="row">
                <span style="height: 80px"></span>
