...
namespace Onder1
{
    public partial class VideoGalleryAdmin : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            grid.DataSource = CatalogAccess.GetAllVideosInAllForAdmin();
            grid.PageSize = 70;/*20;*/
        ...
        protected void grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string videoID = grid.DataKeys[e.RowIndex].Value.ToString();
            bool success = CatalogAccess.DeleteVideoByIDForAdmin(videoID);
