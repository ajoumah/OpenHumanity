...
namespace Onder1
{
    public partial class ProjectsGalleryAmin : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            grid.DataSource = CatalogAccess.GetAllProjectsDetailsForAdmin();
            grid.PageSize = 70;/*20;*/
        ...
        protected void grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string projectID = grid.DataKeys[e.RowIndex].Value.ToString();
            bool success = CatalogAccess.DeleteProjectByIDForAdmin(projectID);
