<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm14.aspx.cs" Inherits="Onder1.WebForm14" %>
...
<body>
                ...
                <ItemTemplate >
                    <div class="item col-2" style="padding-left:2px;padding-right:2px;">
                        <div style="height: 150px;" >
                             ...
                             <asp:Image ImageUrl='<%#Eval("NewsImage")%>' runat="server" ID="ImageNews" CssClass="BorderSectorColor" style="width:100%;height: 100%" />
                        </div>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
                </div>
                <button class="btn btn-primary leftLst" runat="server" onclick="return false;" ><</button>
                <button class="btn btn-primary rightLst" onclick="return false;">></button>
            </div>
  ...
  <script src="content/slick.js" type="text/javascript" charset="utf-8"></script>
