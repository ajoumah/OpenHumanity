<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchImageBox.ascx.cs" Inherits="Onder1.UserControls.SearchImageBox" %>
<asp:Panel ID="searchPanel" runat="server" DefaultButton="goButton">
<table class="SearchBox">
<tr>
<td class="SearchBoxHead">ابحث في الصور</td>
</tr>
<tr>
