<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchVideoBox.ascx.cs" Inherits="Onder1.UserControls.SearchVideoBox" %>
<asp:Panel ID="searchPanel" runat="server" DefaultButton="goButton">
<table class="SearchBox">
<tr>
<td class="SearchBoxHead">ابحث في الفيديو</td>
</tr>
<tr>
