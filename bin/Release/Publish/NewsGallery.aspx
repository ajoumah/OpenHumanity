<%@ Page Title="" Language="C#" MasterPageFile="~/Onder.Master" AutoEventWireup="true" CodeBehind="NewsGallery.aspx.cs" Inherits="Onder1.NewsGallery" EnableViewState="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container bg-faded bg-light">
          ...
          <div class="mt-5 mb-5">
            <asp:Repeater ID="NewsGalleryRepeater" runat="server" OnItemDataBound="NewsRepeater_ItemDataBound"  >
                <ItemTemplate >
