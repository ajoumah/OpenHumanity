<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="AddSingleSectorAdmin.aspx.cs" Inherits="Onder1.AddSingleSectorAdmin" %>
        ...
        <div class="m-5">
            ...
            <div>
                <p class="p-2 text-center">
                    <asp:Label ID="Label1" runat="server" ForeColor="red" Font-Size="30" Text="اضافة قطاع"></asp:Label>
                </p>
            </div>
            <div class="col-xl-12 col-lg-12  col-md-12 col-sm-12 pull-right ">
                <div class="card " style="border-radius: 14px 14px 0 0;">
                    ...
                    <div class="row w-100 p-0 m-0 mb-5 border border-bottom-3 border-dark border-top-0 border-right-0 border-left-0 ">
                        <div class="item w-100" style="direction: rtl; float: right">
                            <p class="col-12 align-content-end  text-right font-style-motto   float-right " style="direction: rtl; float: right">
                                ...
                                <asp:Label ID="TitleLabel" runat="server" Text="عنوان القطاع" Width="100%" class="col-12 align-content-end  text-right    float-right " Style="direction: rtl; float: right"></asp:Label>
                            ...
                            <div class="item col-12 text-right " style="direction: rtl; float: right">
                                <p class=" align-content-end  text-right font-style-motto   float-right " style="direction: rtl; float: right; font-size: 25px">
                                    <asp:RequiredFieldValidator class="item col-12 " Display="Dynamic" Style="direction: rtl; float: right" runat="server" ID="reqName" ControlToValidate="TitleTextBox" ForeColor="Red" ErrorMessage="يجب ادخال عنوان القطاع!" />
                                </p>
                            </div>
                        </div>
                    ...
                    <asp:Label ID="Label2" runat="server" style="font-size: 30px; direction: rtl; padding-right: 30px; padding-bottom: 20px" class="text-right" text="صورة الهيكلية"></asp:Label>
                    <div class="w-100">
                        <div>
                            <asp:Image runat="server" ID="Image1" CssClass="BorderSectorColor" class="bd-placeholder-img  pl-3 pr-3 mt-0" style="width: 100%; height: 412px; border-radius: 10px" />

                        </div>
                        <div class="item col-3 " style="direction: rtl; float: right">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" class="col-12;text-right" runat="server" Display="Dynamic" ForeColor="Red" Font-Size="15" style="direction: rtl; float: right" ErrorMessage="يجب اختيار صورة !" ControlToValidate="fileupload1"></asp:RequiredFieldValidator>
                            ...
                            <asp:FileUpload ID="fileupload1" runat="server" class="col-12;" style="direction: rtl; float: right" />
                        </div>
                    </div>
                    <%--<div class=" text-right border-bottom" style="direction: rtl">
                        ...
                        <div class="  ">
                            ...
                            <p style="font-size: 18px">
                                ...
                                <asp:Label ID="LabelBelongsTo" class="w-100 ml-1 mr-3 pt-2" runat="server" text="القطاع الذي ينتمي له"></asp:Label>
                    ...
                    <div class="card-body  text-right border-bottom" style="direction: rtl">
                        <p class="col-12 font-Sector-paragraph text-right float-right" style="direction: rtl;">
                            <asp:Label ID="Label7" runat="server" text="وصف القطاع"></asp:Label>
                            <asp:RequiredFieldValidator runat="server" ForeColor="Red" id="RequiredFieldValidator2" controltovalidate="DetailsTextBox" errormessage="يجب ادخال وصف القطاع!" />
            ...
            <div class="row ">
                <div class="col text-center">
                    <asp:Button ID="CreateButton" class="btn btn-primary btn-lg" runat="server" Text="اضافة قطاع" Width="200" Height="40" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); font-family: Tajawal; font-size: 20px; border-radius: 12px;" OnClick="CreateButton_Click" />
                </div>
            </div>
            <div class="row">
                <span style="height: 80px"></span>
