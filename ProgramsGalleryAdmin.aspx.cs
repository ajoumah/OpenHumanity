...
namespace Onder1
{
    public partial class ProgramsGalleryAdmin : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            grid.DataSource = CatalogAccess.GetAllProgramDetailsForAdmin();
            grid.PageSize = 70;/*20;*/
        ...
        protected void grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string programID = grid.DataKeys[e.RowIndex].Value.ToString();
            bool success = CatalogAccess.DeleteProgramByIDForAdmin(programID);
