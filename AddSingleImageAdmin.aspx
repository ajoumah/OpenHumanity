<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="AddSingleImageAdmin.aspx.cs" Inherits="Onder1.AddSingleImageAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
             ...
             <asp:Label ID="statusLabel" ForeColor="Red" Font-Size="30" BackColor="Yellow" class="w-100" runat="server" Text=""></asp:Label>
                     ...
                     <div >
                         <p class="p-2 text-center">
                             <asp:Label ID="Label1" runat="server" ForeColor="red" Font-Size="30" Text="اضافة صورة"></asp:Label>
                         </p>
                     </div>   
                            ...
                            <div class="row w-100 p-0 m-0 mb-5 border border-bottom-3 border-dark border-top-0 border-right-0 border-left-0 " >
                               <div class="item w-100" style="direction: rtl; float: right">
                                    <p class="col-12 align-content-end  text-right font-style-motto   float-right " style="direction: rtl;float:right">
                                        ...
                                        <asp:Label ID="TitleLabel" runat="server" Text="عنوان الصورة" Width="100%" class="col-12 align-content-end  text-right    float-right " Style="direction: rtl;float:right"></asp:Label>
                                    ...
                                    <div class="  ">
                                        ...
                                        <span class="glyphicon glyphicon-dashboard ml-5 mr-3 pt-2"> </span>
                                           ...
                                           <asp:Label ID="LabelDate" class=" ml-5 mr-5 pt-2 pr-5" runat="server" DataFormatString = "{0:dd/MM/yyyy}" style="direction:ltr" ></asp:Label>
                                            <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" ForeColor="Red" controltovalidate="datepicker" errormessage="يجب ادخال تاريخ الصورة!" />
 ...
 <span style="height:80px">
         ...
         <div class="row ">
          ...
          <asp:Button ID="CreateButton" class="btn btn-primary btn-lg" runat="server" Text="اضافة صورة" Width="200" Height="40"  style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);font-family:Tajawal;font-size:20px;border-radius: 12px;" OnClick="CreateButton_Click"/>
                 </div>
      </div>
         <div class="row">
<span style="height:80px">
