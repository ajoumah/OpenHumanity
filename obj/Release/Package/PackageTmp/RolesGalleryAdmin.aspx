<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="RolesGalleryAdmin.aspx.cs" Inherits="Onder1.RolesGalleryAdmin" EnableViewState="false"  Theme="OnderShopDefault" %>
    ...
    <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" style="overflow: auto;height: 600px; " class="p-5" >
        ...
        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="true" DataKeyNames="Id" dir="rtl" AllowPaging="true" OnPageIndexChanging="grid_PageIndexChanging"
             ...
             <Columns>
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="UserNameTextBox" runat="server"
                        Text='<%# Bind("Name") %>' Height="70px" TextMode="MultiLine"
          ...
          <asp:HyperLinkField DataNavigateUrlFields="Id"
                DataNavigateUrlFormatString="RoleAdmin.aspx?Id={0}"
                HeaderText="تعديل المجموعة" Text="تعديل" />
      
            <asp:TemplateField HeaderText="حذف المجموعة">
                <ItemTemplate>
                    <asp:ImageButton ID="DeleteButton" runat="server" ImageUrl="~/images/cross.png"
                        CommandName="Delete" OnClientClick="return confirm('هل تريد حذف المجموعة؟');"
