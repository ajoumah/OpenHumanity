<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="ImageGalleryAdmin.aspx.cs" Inherits="Onder1.ImageGalleryAdmin" EnableViewState="false"  Theme="OnderShopDefault" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" class="p-5">
    ...
    <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" style="overflow: auto;height: 600px; " class="p-5" >
        ...
        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="true" DataKeyNames="ImageID" dir="rtl" AllowPaging="true" OnPageIndexChanging="grid_PageIndexChanging"
            OnRowDeleting="grid_RowDeleting" >
             <Columns>
                 <asp:TemplateField HeaderText="رقم الصورة">
                
                <EditItemTemplate>
                    <asp:TextBox ID="ImageIDTextBox" runat="server"
                        Text='<%# Bind("ImageID") %>' Height="70px" TextMode="MultiLine"
                        Width="400px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="ImageIDLabel" runat="server" Text='<%# Eval("ImageID") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="التاريخ"
                ...
                DataNavigateUrlFormatString="SingleImageShow.aspx?ImageID={0}"
                HeaderText="رابط الصورة" Text="الرابط" />
          <asp:HyperLinkField DataNavigateUrlFields="ImageID"
                DataNavigateUrlFormatString="SingleImageAdmin.aspx?ImageID={0}"
                HeaderText="تعديل الصورة" Text="تعديل" />
      
            <asp:TemplateField HeaderText="حذف الصورة">
                <ItemTemplate>
                    <asp:ImageButton ID="DeleteButton" runat="server" ImageUrl="~/images/cross.png"
                        CommandName="Delete" OnClientClick="return confirm('هل تريد حذف الصورة?');"
