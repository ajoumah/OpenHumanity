<%@ Page Title="" Language="C#" MasterPageFile="~/Onder.Master" AutoEventWireup="true" CodeBehind="Project.aspx.cs" Inherits="Onder1.Project" EnableViewState="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container bg-faded bg-light">
        ...
        <div class="row  mt-4 mb-5 mr-0 ml-0 pr-0">
            ...
            <div class="row col-xl-9 col-lg-9  col-md-12 col-sm-12  breadcrumb flat" id="rowSector" runat="server">
                ...
                <a  runat="server" class=" SectorBackgoundColor " style="max-width: 33%;" id="SectorNameLink1">
                    <asp:Label ID="SectorNameLabel" runat="server"></asp:Label></a>
                <a  style="max-width: 33%;" runat="server" class="btn-lg SectorBackgoundColor " id="SectorNameLink2">
                    <asp:Label ID="ProgramNameLabel" runat="server"></asp:Label></a>
                <a  runat="server" class=" SectorBackgoundColor " style="max-width: 33%;" id="SectorNameLink3">
                    <asp:Label ID="ProjectNameLabel" runat="server"></asp:Label></a>
        ...
        <%--<div class="col-12 mt-5">
                <div class="col-11 float-left " >
                    <p class=" text-right font-Sector-header ">الهيكل التنظيمي للمشاريع</p>
                </div>
                <div class="col-1 float-right">
               
                    <button type="button" class="border-0 bg-light mt-2 Opacity" data-toggle="modal" data-target="#myModal">
                       <asp:Image alt=" eye" class=" " runat="server" Id="ImageEye"  />
                   </button>
                </div>
           </div>  --%> 
        
        <%--<div class="modal " id="myModal" >
            <div class="modal-dialog-centered mx-auto w-75   text-center" >
                <div class="modal-content p-0 m-0 mx-auto w-100   text-center" style="max-width:1200px">

                    
                    <div class="modal-header mx-auto w-100   text-center" >
                        
                        <button type="button" class="close pull-right" data-dismiss="modal">&times;</button>
                    </div>

                    
                    <div class="modal-body mx-auto    text-center  justify-content-center"  style="padding:0 !important">
                        <asp:Image id="StuctureImage" runat="server" class="modal-body mx-auto w-100 p-0 m-0" style="max-width:1200px" />
                    </div>
  ...
  <div class="container marketing bg-light">
    ...
    <!-- START THE FEATURETTES -->
      ...
      <%--<div class="container bg-faded bg-light">
          <p class="text-right display-4 SectorColor">البرامج</p>
          <div class=" ">
              <asp:Repeater ID="Repeater1" runat="server"  >
                <ItemTemplate  >
                    <div class="pt-5   col-xl-3 col-lg-12  col-md-12 col-sm-12 pull-right">
                        <div class="" >
                            <div class="card" style="border-radius: 14px;">
                                
                                 <asp:Image ImageUrl='<%#Eval("Image")%>' runat="server" id="btnEditComment" Width="100%"  height="291px" style="border-radius: 14px;"   />
                            ...
                            <div class="  pt-3  text-right border-bottom SectorColor font-programs-paragraph-header" >
                               
                                <asp:Label ID="Label2" runat="server"  Text='<%#Eval("Name")%>'></asp:Label>
                            </div>
                            
                            <div class=" pt-3  text-right border-bottom font-programs-paragraph" style="direction:rtl;" >
                                
                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("Description")%>' ></asp:Label>
                            </div>
                            <div class=" card-body pr-0 text-right border-bottom">
                                
                                <p><a class="btn more-news btn-sm SectorBackgoundColor" href='<%# Onder1.Class1.ToProgram((Eval("ProgramID").ToString()))%>' style="color:white;direction:rtl;" role="button">المزيد  &raquo;</a></p>
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <div class=' item <%# GetClass(Container.ItemIndex) %> mySlidesOfProjects ' style="border-radius:14px;background-color:#f8f9fa!important">
                                ...
                                <div class="carousel-caption d-sm-block SectorBackgoundColor mx-auto w-25  mb-0 text-center pt-2" style="top:340px;height:5%;padding:0;border-radius:14px" >
                                    <asp:Label ID="Label2" runat="server"  Text='<%#  Convert.ToString(Container.ItemIndex+1)+"   /  "+ GlobeRows %>'></asp:Label>
                    ...
                    <asp:Repeater ID="VideoRepeater" runat="server"  >
                        <ItemTemplate>
                            <div class=' item <%# GetClass(Container.ItemIndex) %> mySlidesOfProjects ' style="border-radius:14px;background-color:#f8f9fa!important">
                                ...
                                <div class="carousel-caption d-sm-block SectorBackgoundColor mx-auto w-25  mb-0 text-center pt-2" style="top:340px;height:5%;padding:0;border-radius:14px" >
                                    <asp:Label ID="Label2" runat="server"  Text='<%#  Convert.ToString(Container.ItemIndex+1)+"   /  "+ GlobeVideoRows %>'></asp:Label>
