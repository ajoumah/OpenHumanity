<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="SingleVideoAdmin.aspx.cs" Inherits="Onder1.SingleVideoAdmin" %>
     ...
     <div class="m-5">
         ...
         <p class="p-5 text-center col-12 align-content-end  text-right font-style-motto">
             ...
             <asp:Label ID="statusLabel" ForeColor="Red" Font-Size="30" BackColor="Yellow" class="w-100" runat="server" Text=""></asp:Label>
                     ...
                     <div >
                         <p class="p-2 text-center">
                             <asp:Label ID="Label1" runat="server" ForeColor="red" Font-Size="30" Text="تعديل الفيديو"></asp:Label>
                         </p>
                     </div>   
                        ...
                        <div class="card " style="border-radius: 14px 14px 0 0;">
                            ...
                            <div class="row w-100 p-0 m-0 mb-5 border border-bottom-3 border-dark border-top-0 border-right-0 border-left-0 ">
                                <p class="col-12 align-content-end  text-right font-style-motto  ">
                                    <asp:Label ID="TitleLabel" runat="server" text="عنوان الفيديو"></asp:Label>
                            ...
                            <asp:Label ID="Label5" runat="server" style="font-size:30px;width:100%;direction:rtl;" class="text-right" text="الفيديو "></asp:Label>
                            <div class="w-100">
                                 ...
                                 <iframe id="VideoFrame"  runat="server" class="BorderSectorColor bd-placeholder-img w-100 pl-3 pr-3 mt-0" style="width:100%;height:412px;border-radius:10px;border: none;"  allowfullscreen></iframe> 
                            ...
                            <div class="w-100 mx-auto p-3  text-right ">
                                ...
                                <br />
                                  <asp:Label ID="Label2" runat="server" text="رابط الفيديو " style="font-size:20px;"></asp:Label>
                                    ...
                                    <asp:TextBox ID="TextBoxVideoDetails"  runat="server" Style="direction: rtl;"   TextMode="MultiLine" Width="100%"  minlength="<%#TextBoxVideoUrl.Text.Length %>"    ></asp:TextBox>
