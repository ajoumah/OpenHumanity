<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="UserAdmin.aspx.cs" Inherits="Onder1.UserAdmin"   Theme="OnderShopDefault"%>
     ...
     <div class="m-5">
         ...
         <p class="p-5 text-center col-12 align-content-end  text-right font-style-motto">
             ...
             <asp:Label ID="statusLabel" ForeColor="Red" Font-Size="30" BackColor="Yellow" class="w-100" runat="server" Text=""></asp:Label>
                     ...
                     <div >
                         <p class="p-2 text-center">
                             <asp:Label ID="Label1" runat="server" ForeColor="red" Font-Size="30" Text="تعديل المستخدم"></asp:Label>
                         </p>
                     </div>   
                    <div class="col-xl-12 col-lg-12  col-md-12 col-sm-12 pull-right ">
                        <div class="card " style="border-radius: 14px 14px 0 0;">
                            ...
                            <asp:Label ID="Label5" runat="server" style="font-size:30px;width:100%;direction:rtl;" class="text-right" text="اسم المستخدم : "></asp:Label>
                            ...
                            <div class=" text-right border-bottom" style="direction:rtl">
                                    ...
                                    <%--<div class="  ">
                                        ...
                                        <p style="font-size:18px">
                                            <asp:Label ID="Label2" runat="server" style="font-size:30px;width:100%;direction:rtl;" class="text-right" text="المجموعة التي ينتمي لها "></asp:Label>     
                                 ...
                                 <asp:GridView ID="grid" runat="server" AutoGenerateColumns="true" DataKeyNames="Id" dir="rtl" AllowPaging="true" EnableViewState="false"
                                     Font-Size="20">
                                      <Columns>
                                          <asp:TemplateField HeaderText=" المجموعات المضاف لها">
                                     ...
                                     <asp:CheckBoxList ID="CheckBoxList1" cssClass="checkBoxList" runat="server" DataTextField="projectName" class="checkBx"
