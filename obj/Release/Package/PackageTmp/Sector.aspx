<%@ Page Title="" Language="C#" MasterPageFile="~/Onder.Master" AutoEventWireup="true" CodeBehind="Sector.aspx.cs" Inherits="Onder1.Sector1" EnableViewState="false" %>
...
<%-- here we add some code --%>
<%--<%@ MasterType VirtualPath="~/Onder.Master" %>  --%>
<%-- end of code --------- --%>
        ...
        <div class="modal " id="myModal" >
            <div class="modal-dialog-centered mx-auto w-75   text-center" >
                <div class="modal-content p-0 m-0 mx-auto w-100   text-center" style="max-width:1200px">
                    ...
                    <!-- Modal footer -->
                    <%--<div class="modal-footer mx-auto w-75 p-3  text-center" style="max-width:1200px">
